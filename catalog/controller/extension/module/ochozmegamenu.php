...
class ControllerExtensionModuleOchozmegamenu extends Controller {
	public function index($setting) { 
		...
		$html .='<li><span class=" button-view1 no-close"><a href="/wholesale">WHOLESALE</a><span class="ttclose"><a href="javascript:void(0)"></a></span></span><ul class="level2" style="display: none;"></ul></li>'	;
		$html .='</ul>'	;
