...
<div class="container">
	...
	<div class="jrc_chat_form">
		...
		<?php if (isset($online_oplist_whatsapp) && !empty($online_oplist_whatsapp)) foreach ($online_oplist_whatsapp as $o) { ?>
			...
			<?php echo ($o["isonline"] ? '<a href="https://web.whatsapp.com/send?phone='.$o["whatsappnumber"].'&text='.urlencode($jakwidget["whatsapp_message"]).'" data-number="'.$o["whatsappnumber"].'" data-auto-text="'.$jakwidget["whatsapp_message"].'" target="_blank">' : '');?>
