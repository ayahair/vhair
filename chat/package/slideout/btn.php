...
if ($USR_IP_BLOCKED) {
	...
	if (isset($jakwidget['buttonimg']) && !empty($jakwidget['buttonimg'])) {
		...
		$btnwidthdiv = 'style="width:'.$btnwidth.'px;"';
	...
	if ($online_op) {
		...
		if ($jakwidget['widget'] == 1 || $jakwidget['widget'] == 3) {
			...
			$widgethtml = '<div id="lcjframesize" class="live-chat-slideout-container animated"><div id="lcj-proactive"><p></p><span class="yes" onclick="lcjak_engageOpen();return false;"></span><span class="no" onclick="lcjak_engageClose();return false;"></span></div><div id="lcj-lastmessage"><p></p></div>'.$slideimg.'<div class="lcj-chat-header'.$theme.'" style="'.$titlefont.'"><a href="'.$chatstarturl.'"><span class="lcj-sprite lcj-sprite-logo"></span><div class="lcj-title">'.$jakwidget['title'].'</div></a>'.$thepoup.'</div>';
	...
	// No operator is online or user is blocked
	    ...
	    // We will show the contact form
			...
			if ($jakwidget['widget'] == 1 || $jakwidget['widget'] == 3) {
				...
				$widgethtml = '<div id="lcjframesize" class="live-chat-slideout-container animated"><div id="lcj-proactive"><p></p><span class="yes" onclick="lcjak_engageOpen();return false;"></span><span class="no" onclick="lcjak_engageClose();return false;"></span></div><div id="lcj-lastmessage"><p></p></div>'.$slideimg.'<div class="lcj-chat-header'.$theme.'" style="'.$titlefont.'"><a href="'.$chatcontacturl.'"><span class="lcj-sprite lcj-sprite-logo"></span><div class="lcj-title">'.$jakwidget['title'].'</div></a>'.$thepoup.'</div>';
