        ...
        <div class="col-2 tooltipwrap">
              <label>
                <span class="tooltip"><?php echo $jkl["g18"];?></span>
                  <input type="radio" name="avatar" value="/package/standard/avatar/standard.jpg"<?php if (isset($_SESSION['jrc_avatar']) && $_SESSION['jrc_avatar'] == "/package/standard/avatar/standard.jpg") echo ' checked';?>>
                  <img src="<?php echo BASE_URL;?>/package/standard/avatar/standard.jpg" width="53" class="rounded img-fluid" alt="avatar">
                </label>
            </div>
            <div class="col-2">
              <label>
                  <input type="radio" name="avatar" value="/package/standard/avatar/4.jpg"<?php if (isset($_SESSION['jrc_avatar']) && $_SESSION['jrc_avatar'] == "/package/standard/avatar/4.jpg") echo ' checked';?>>
                  <img src="<?php echo BASE_URL;?>/package/standard/avatar/4.jpg" width="53" class="rounded img-fluid" alt="avatar">
                </label>
            </div>
            <div class="col-2">
              <label>
                  <input type="radio" name="avatar" value="/package/standard/avatar/2.jpg"<?php if (isset($_SESSION['jrc_avatar']) && $_SESSION['jrc_avatar'] == "/package/standard/avatar/2.jpg") echo ' checked';?>>
                  <img src="<?php echo BASE_URL;?>/package/standard/avatar/2.jpg" width="53" class="rounded img-fluid" alt="avatar">
                </label>
            </div>
            <div class="col-2">
              <label>
                  <input type="radio" name="avatar" value="/package/standard/avatar/5.jpg"<?php if (isset($_SESSION['jrc_avatar']) && $_SESSION['jrc_avatar'] == "/package/standard/avatar/5.jpg") echo ' checked';?>>
                  <img src="<?php echo BASE_URL;?>/package/standard/avatar/5.jpg" width="53" class="rounded img-fluid" alt="avatar">
                </label>
            </div>
            <div class="col-2">
              <label>
                  <input type="radio" name="avatar" value="/package/standard/avatar/3.jpg"<?php if (isset($_SESSION['jrc_avatar']) && $_SESSION['jrc_avatar'] == "/package/standard/avatar/3.jpg") echo ' checked';?>>
                  <img src="<?php echo BASE_URL;?>/package/standard/avatar/3.jpg" width="53" class="rounded img-fluid" alt="avatar">
                </label>
            </div>
            <div class="col-2">
              <label>
                  <input type="radio" name="avatar" value="/package/standard/avatar/1.jpg"<?php if (isset($_SESSION['jrc_avatar']) && $_SESSION['jrc_avatar'] == "/package/standard/avatar/1.jpg") echo ' checked';?>>
                  <img src="<?php echo BASE_URL;?>/package/standard/avatar/1.jpg" width="53" class="rounded img-fluid" alt="avatar">
                </label>
            </div>
      </div>
  </div>
  <?php } ?>
    ...
    <div class="text-center">
          ...
          <div class="form-group">
            ...
            <input type="tel" name="phone" id="phone" class="form-control underlined" value="<?php if (isset($_SESSION['jrc_phone'])) echo $_REQUEST["jrc_phone"];?>" placeholder="<?php echo $jkl["g49"];?>">
          </div>
      </div>
