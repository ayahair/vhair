...
<div class="smooth-form">
    ...
    <?php if (isset($online_oplist_whatsapp) && !empty($online_oplist_whatsapp)) foreach ($online_oplist_whatsapp as $o) { ?>
      ...
      <?php echo ($o["isonline"] ? '<a href="https://web.whatsapp.com/send?phone=<?php echo $o["whatsappnumber"];?>&text=<?php echo urlencode($jakwidget["whatsapp_message"]);?>" data-number="<?php echo $o["whatsappnumber"];?>" class="wptwa-account wptwa-clearfix" data-auto-text="<?php echo $jakwidget["whatsapp_message"];?>" target="_blank">' : '');?>
