	...
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			if ($catalog) {
				...
				$cireviewpro = array();
				if ($this->user->hasPermission('access', 'cireviewpro/cireviews')) {
					$this->load->language('cireviewpro/cireviewpro_menu');
					$cireviewpro[] = array(
						'name'	   => $this->language->get('text_cireviews'),
						'href'     => $this->url->link('cireviewpro/cireviews', 'token=' . $this->session->data['token'], true),
						'children' => array()
					);
				}
				if ($this->user->hasPermission('access', 'cireviewpro/ciabreason')) {
					$this->load->language('cireviewpro/cireviewpro_menu');
					$cireviewpro[] = array(
						'name'	   => $this->language->get('text_ciabreason'),
						'href'     => $this->url->link('cireviewpro/ciabreason', 'token=' . $this->session->data['token'], true),
						'children' => array()
					);
				}
				if ($this->user->hasPermission('access', 'cireviewpro/cireviewpro_invite')) {
					$this->load->language('cireviewpro/cireviewpro_menu');
					$cireviewpro[] = array(
						'name'	   => $this->language->get('text_cireviewpro_invite'),
						'href'     => $this->url->link('cireviewpro/cireviewpro_invite', 'token=' . $this->session->data['token'], true),
						'children' => array()
					);
				}
				
				if ($this->user->hasPermission('access', 'cireviewpro/cireviewpro_invitelog')) {
					$this->load->language('cireviewpro/cireviewpro_menu');
					$cireviewpro[] = array(
						'name'	   => $this->language->get('text_cireviewpro_invitelog'),
						'href'     => $this->url->link('cireviewpro/cireviewpro_invitelog', 'token=' . $this->session->data['token'], true),
						'children' => array()
					);
				}
				
				if ($this->user->hasPermission('access', 'cireviewpro/cireviewpro_cron')) {
					$this->load->language('cireviewpro/cireviewpro_menu');
					$cireviewpro[] = array(
						'name'	   => $this->language->get('text_cireviewpro_cron'),
						'href'     => $this->url->link('cireviewpro/cireviewpro_cron', 'token=' . $this->session->data['token'], true),
						'children' => array()
					);
				}
				
				if ($this->user->hasPermission('access', 'cireviewpro/ciratingtype')) {
					$this->load->language('cireviewpro/cireviewpro_menu');
					$cireviewpro[] = array(
						'name'	   => $this->language->get('text_ciratingtype'),
						'href'     => $this->url->link('cireviewpro/ciratingtype', 'token=' . $this->session->data['token'], true),
						'children' => array()
					);
				}

				if ($this->user->hasPermission('access', 'cireviewpro/cireviewpro')) {
					$this->load->language('cireviewpro/cireviewpro_menu');
					$cireviewpro[] = array(
					...
					if ($cireviewpro) {
						$data['menus'][] = array(
							'id'       => 'menu-cireviewpro',
							'icon'	   => 'fa fa-star-o', 
							'name'	   => $this->language->get('text_cireviewpro'),
							'href'     => '',
							'children' => $cireviewpro
						);		
					}

					$catalog = array_merge($catalog, $cireviewpro);
				}
