...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getList() {
		...
		$data['footer'] = $this->load->controller('common/footer');
				...
				$data['linkseobulk'] = '../index.php?route=seo/hb_seo/autobrandseo&passkey='.$this->config->get('hb_seo_bulk_passkey');
	...
	protected function getForm() {
		...
		$data['entry_image'] = $this->language->get('entry_image');
				...
				$data['col_h1'] = $this->language->get('col_h1');
				$data['col_h2'] = $this->language->get('col_h2');
				$data['col_meta_desc'] = $this->language->get('col_meta_desc');
				$data['col_meta_key'] = $this->language->get('col_meta_key');
				$data['col_description'] = $this->language->get('col_description');
		...
		if (isset($this->request->post['manufacturer_store'])) {
			...
			$data['manufacturer_store'] = array(0);
				...
				if (isset($this->request->post['col_title'])) {
					$data['col_title'] = $this->request->post['col_title'];
				} elseif (!empty($manufacturer_info)) {
					$data['col_title_value'] = $manufacturer_info['custom_title'];
				} else {
					$data['col_title_value'] = '';
				}
				
				if (isset($this->request->post['col_h1'])) {
					$data['col_h1'] = $this->request->post['col_h1'];
				} elseif (!empty($manufacturer_info)) {
					$data['col_h1_value'] = $manufacturer_info['custom_h1'];
				} else {
					$data['col_h1_value'] = '';
				}
				
				if (isset($this->request->post['col_h2'])) {
					$data['col_h2'] = $this->request->post['col_h2'];
				} elseif (!empty($manufacturer_info)) {
					$data['col_h2_value'] = $manufacturer_info['custom_h2'];
				} else {
					$data['col_h2_value'] = '';
				}
				
				if (isset($this->request->post['col_meta_desc'])) {
					$data['col_meta_desc'] = $this->request->post['col_meta_desc'];
				} elseif (!empty($manufacturer_info)) {
					$data['col_meta_desc_value'] = $manufacturer_info['brand_meta_description'];
				} else {
					$data['col_meta_desc_value'] = '';
				}
				
				if (isset($this->request->post['col_meta_key'])) {
					$data['col_meta_key'] = $this->request->post['col_meta_key'];
				} elseif (!empty($manufacturer_info)) {
					$data['col_meta_key_value'] = $manufacturer_info['brand_meta_keyword'];
				} else {
					$data['col_meta_key_value'] = '';
				}
				
				if (isset($this->request->post['col_description'])) {
					$data['col_description'] = $this->request->post['col_description'];
				} elseif (!empty($manufacturer_info)) {
					$data['col_description_value'] = $manufacturer_info['brand_description'];
				} else {
					$data['col_description_value'] = '';
				}
