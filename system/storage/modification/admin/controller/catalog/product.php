...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		$data['footer'] = $this->load->controller('common/footer');
				...
				$data['linkseobulk'] = '../index.php?route=seo/hb_seo/productcron&passkey='.$this->config->get('hb_seo_bulk_passkey');
				$data['hb_seo_bulk_auto'] = $this->config->get('hb_seo_bulk_auto');
				

				$data['linktags'] = $this->url->link('extension/hb_tags/autogeneratetags', 'token=' . $this->session->data['token'], true);
				$data['hb_tag_automatic'] = $this->config->get('hb_tags_auto');
				
$data['linkpsitemap'] = '../index.php?route=sitemap/hb_sitemap/productxmlcron&store_id=all&cron=1&passkey='.$this->config->get('hb_sitemap_passkey');
	...
	protected function getForm() {
		...
		$data['entry_tag'] = $this->language->get('entry_tag');
				...
				$data['col_img_alt'] = $this->language->get('col_img_alt');
