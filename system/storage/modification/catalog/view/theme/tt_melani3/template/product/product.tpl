...
<?php } ?>
						...
						<?php if ($thumb || $images) { ?>
							<div class="thumbnails">
								<?php if ($thumb) { ?>
									...
									<img src="<?php echo $thumb; ?>" data-zoom-image="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $img_alt; ?>" />
									</a>
								<?php } ?>
							</div>
							<div class="image-additional-container owl-style3">
								<div class="owl-container">
									<div class="image-additional" id="gallery_01">
										<?php if ($thumb) { ?>
										<a class="thumbnail" style="display: none" href="#" data-image="<?php echo $thumb; ?>" data-zoom-image="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $img_alt; ?>" /></a>
										<?php } ?>
										<?php if ($images) { ?>
										<?php foreach ($images as $image) { ?>
										<a style="display: none" class="thumbnail" href="#" data-image="<?php echo $image['thumb']; ?>" data-zoom-image="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>"> <img src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $img_alt; ?>" /></a>
										<?php } ?>
										<?php } ?>
									</div>
								</div>
				...
				<div class="col-3 product-info-detailed">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-description"><h2><?php echo $custom_p_h2; ?></h2><?php echo $description; ?></div>
						<?php if ($attribute_groups) { ?>
