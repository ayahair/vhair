...
<?php } ?>
      ...
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <ul class="thumbnails">
            <?php if ($thumb) { ?>
            <li><a class="thumbnail" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $img_alt; ?>" /></a></li>
            <?php } ?>
            <?php if ($images) { ?>
            <?php foreach ($images as $image) { ?>
            <li class="image-additional"><a class="thumbnail" href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>"> <img src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $img_alt; ?>" /></a></li>
            <?php } ?>
            <?php } ?>
          </ul>
          <?php } ?>
        ...
        <div class="<?php echo $class; ?>">
          ...
          <div id="product">
			...
			<input type="button" title="Buy Now" value="Buy Now" data-loading-text="<?php echo $text_loading; ?>" id="button-buynow" class="btn btn-primary btn-lg btn-block" />
