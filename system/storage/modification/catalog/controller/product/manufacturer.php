...
$data['hb_snippets_bc_enable'] = $this->config->get('hb_snippets_bc_enable');
	...
	public function info() {
		...
		if ($manufacturer_info) {
			...
			if (!empty($manufacturer_info['custom_title'])){
				$this->document->setTitle($manufacturer_info['custom_title']);
			}else{
				$this->document->setTitle($manufacturer_info['name']);
			}
			$this->document->setDescription($manufacturer_info['brand_meta_description']);
			$this->document->setKeywords($manufacturer_info['brand_meta_keyword']);
			$data['custom_m_h2'] = $manufacturer_info['custom_h2'];
			$data['brand_description'] =$manufacturer_info['brand_description'];
			...
			if (!empty($manufacturer_info['custom_h1'])){
				$data['heading_title'] = $manufacturer_info['custom_h1'];
			}else{
