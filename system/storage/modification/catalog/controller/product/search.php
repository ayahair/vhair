		...
		$data['limit'] = $limit;
				...
				if ($data['products']){
						...
						if (isset($this->request->get['tag'])) {
							...
							$hbst_meta_title = $this->config->get('hb_searchtag_tmt_'.$language_id);
							$hbst_meta_description = $this->config->get('hb_searchtag_tmd_'.$language_id);
							$hbst_meta_keyword = $this->config->get('hb_searchtag_tmk_'.$language_id);
						}
						if (isset($this->request->get['search'])) {
							$tagword = $this->request->get['search'];
							$hbst_meta_title = $this->config->get('hb_searchtag_smt_'.$language_id);
							$hbst_meta_description = $this->config->get('hb_searchtag_smd_'.$language_id);
							$hbst_meta_keyword = $this->config->get('hb_searchtag_smk_'.$language_id);
						}
						
						$hbst_meta_title = str_replace('{tag}',$tagword, $hbst_meta_title);
						$hbst_meta_title = str_replace('{total}',$total_results, $hbst_meta_title);
						$hbst_meta_title = str_replace('{store_name}',$store_name, $hbst_meta_title);
						...
						$hbst_meta_description = str_replace('{store_name}',$store_name, $hbst_meta_description);
