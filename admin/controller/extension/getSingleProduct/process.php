...
$marketsException = array("play" , "ekey" , "taobao" , "krauta", 'alibaba', "dadonline" , "audiotechnica" , "sony");
// check for ajax
if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest' && isset($_POST['data']) && isset($_POST['token']) && isset($_POST['data']['url'])){
	...
	if(strpos($data['url'] , $_POST['donorMarket']) || in_array( $_POST['donorMarket'] , $marketsException)){
		...
		//echo $out['sku'];
		if(isset($data["quantity"]) && $data["quantity"] == "on" && function_exists("mspro_" . $_POST['donorMarket'] ."_quantity")){$out['quantity'] = call_user_func("mspro_" . $_POST['donorMarket'] ."_quantity" , $html);}
		...
		if(isset($data["jan"]) && $data["jan"] == "on" && function_exists("mspro_" . $_POST['donorMarket'] ."_jan")){$out['jan'] = call_user_func("mspro_" . $_POST['donorMarket'] ."_jan" , $html);}
		...
		if(isset($data["price"]) && $data["price"] == "on" && function_exists("mspro_" . $_POST['donorMarket'] ."_price")){$out['price'] = call_user_func("mspro_" . $_POST['donorMarket'] ."_price" , $html , $url);}
