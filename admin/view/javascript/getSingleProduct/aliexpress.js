...
/* SYSTEM SETTINGS */
GetSingleProduct_aliexpress.scriptsLocation = '/catalog/controller/extension';
...
GetSingleProduct_aliexpress.javaScriptsLocation = '/admin/view/javascript';
GetSingleProduct_aliexpress.scriptsLocation = '/admin/controller/extension';
...
if( (jQuery.ui == undefined || jQuery.ui.dialog == undefined) && isset("GetSingleProduct_assembly.subfolder") ){
	if(GetSingleProduct_assembly.subfolder.length > 1){
		...
		document.write('<script type="text/javascript" src="' + subFolderPrefix + GetSingleProduct_aliexpress.javaScriptsLocation + '/getSingleProduct/js/jquery_ui/jquery-ui.min.js"></script>');
		document.write('<link type="text/css" href="' + subFolderPrefix + GetSingleProduct_aliexpress.javaScriptsLocation + '/getSingleProduct/js/jquery_ui/jquery-ui.min.css" rel="stylesheet" />');
	}
}
...
if(jQuery.ui == undefined || jQuery.ui.dialog == undefined){
	document.write('<script type="text/javascript" src="' + GetSingleProduct_aliexpress.javaScriptsLocation + '/getSingleProduct/js/jquery_ui/jquery-ui.min.js"></script>');
	document.write('<link type="text/css" href="' + GetSingleProduct_aliexpress.javaScriptsLocation + '/getSingleProduct/js/jquery_ui/jquery-ui.min.css" rel="stylesheet" />');
}
...
function get_form_data_aliexpress(lang_id){
	if(GetSingleProduct_aliexpress.semafor < 1){
		...
		var parsingPath = ".." + GetSingleProduct_aliexpress.scriptsLocation + "/getSingleProduct/process.php";
		var parsingData = {
